...
def display_num_of_messages(
    chat_data: pd.DataFrame, per_year: bool = False, plot_title=""
):
    """
...
def get_frequency_info(
    chat_data, column, column_renamed, sorting_order, author_names, plot_title=""
):
    c_gaps = [
...
def display_biggest_spammer(chat_data: pd.DataFrame):
    ...
    fig.update_layout(
        title={
            "text": f"Percentage of external links shared per person: {author_names[idx_spammer]} is the biggest spammer.",
            "y": 0.1,
            "x": 0.5,
            "xanchor": "center",
            "yanchor": "top",
...
def handle_signal_media(chat_data: pd.DataFrame):
    ...
    fig_gifs.update_layout(
        title={
            "text": f"Percentage of GIFs shared per person: {gif_person} shares the most GIFs.",
            "y": 0.1,
            "x": 0.5,
            "xanchor": "center",
            "yanchor": "top",
    ...
    fig_audios.update_layout(
        title={
            "text": f"Percentage of audio messages shared per person: {audio_person} really likes to send audios.",
            "y": 0.1,
            "x": 0.5,
            "xanchor": "center",
            "yanchor": "top",
...
def handle_android_media(chat_data: pd.DataFrame, prase: str):
    ...
    fig.update_layout(
        title={
            "text": f"Percentage of messages containing media (i.e. images, GIFs, audios)",
            "y": 0.1,
            "x": 0.5,
            "xanchor": "center",
            "yanchor": "top",
...
def display_quote(chat_data: pd.DataFrame):
    ...
    font = ImageFont.truetype(
        "./assets/fonts/Philosopher-BoldItalic.ttf", 32, encoding="unic"
    )
